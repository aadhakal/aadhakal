<div align="center">
  <table style="background:#f9f9f9; padding: 20px; border-radius: 10px; width: 90%; max-width: 1200px;">
    <tr>
      ...
      <td style="text-align: right;">
        <img src="https://github.com/aadhakal/aadhakal/blob/main/heatmap_after_joining_cs_simple.png" alt="CS Effort Heatmap" width="1300" />
      </td>
    </tr>
  </table>
</div>
...
<h2>🎉 About Me</h2>
<ul>
  <li>📚 Currently solving LeetCode over coffee for fun (and maybe interviews).</li>
  <li>🚀 Prototyping AI agents, edge robotics, and backend systems that (usually) behave.</li>
  <li>✍️ Built with everything from TensorFlow to TypeScript — sometimes in the same project.</li>
  <li>🧪 From low-level sensors to cloud deployments — I enjoy wiring things end-to-end.</li>
</ul>
...
<li> 🧬 <strong><a href="https://github.com/aadhakal/Deep-Learning">Deep Learning Repo</a></strong> — A collection of hands-on deep learning implementations from RNNs and attention models to autoencoders</li>
</ul>
...
<p>
  <a target="_blank" href="https://www.linkedin.com/in/aashishdhakal" style="display: inline-block;">
...
<p>I’m always open to new opportunities, meaningful conversations, and ways to build impactful technology. Let’s connect!</p>
